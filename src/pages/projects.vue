...
<template>
  <main class="grid grid-cols-12 grid-rows-[max-content_1fr] place-content-center text-sm 2xl:text-5">
    <div class="border-b col-span-full h-8 grid grid-cols-12">
      <h2 class="col-span-2 border-r pl-4 flex items-center">
        projects
      </h2>
    </div>
